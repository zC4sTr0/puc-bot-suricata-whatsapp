...
Origem: `C:/GIT/puc-ciencia-dados-ia/suricata`, extraída por allowlist controlada, preservando o layout conhecido para não misturar refatoração com separação.
